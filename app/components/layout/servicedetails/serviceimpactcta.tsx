      ...
      return (
        <div
          ...
          className={`flex items-center gap-4 py-2 px-4 lg:px-6 ${
            idx > 0 ? 'lg:border-l lg:border-dashed lg:border-white/40' : ''
          }`}
        >
